...
Open **Profile → menu (☰) → Buddies** for your roster.
...
On dive detail **Map** tab → **Buddies** → **+**:
...
Photos and videos where you tagged yourself appear in the **Profile** header (hero), same idea as a buddy’s tagged-media banner.
