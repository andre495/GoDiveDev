...
struct EquipmentLockerView: View {
    ...
    var body: some View {
        ZStack {
            AppPage(title: "Equipment Locker", showsBackButton: true) {
                Group {
                    if ownedEquipment.isEmpty {
                        VStack(alignment: .leading, spacing: AppTheme.Spacing.lg) {
                            addEquipmentBannerButton
                            emptyLockerState
                        }
                    } else {
                        equipmentList
    ...
    private var addEquipmentBannerButton: some View {
        Button {
    ...
    private var emptyLockerState: some View {
        VStack(spacing: AppTheme.Spacing.md) {
            ...
            Text("Tap Add new equipment to log your first item.")
                .font(.body)
