...
/// Catalog picker to add dive-level marine life tags on the map tab (blue overview-panel modal).
/// Pre-checks species already tagged via media or dive-level so each species appears once.
struct DiveActivityMarineLifeTagPickerSheet: View {
    ...
    var body: some View {
        ...
        .accessibilityIdentifier("DiveActivityMarineLifeTagPicker.Root")
    }
    ...
    private var speciesSearchChrome: some View {
        CatalogListSearchChrome(
            ...
            searchFieldAccessibilityIdentifier: "DiveActivityMarineLifeTagPicker.SearchField",
            cancelAccessibilityIdentifier: "DiveActivityMarineLifeTagPicker.SearchCancel",
    ...
    private func reloadTaggedMarineLifeUUIDs() {
        ...
        )) ?? activityFallbackSightings()
        persistedMarineLifeUUIDs = DiveActivityMarineLifeOverviewPresentation.uniqueMarineLifeUUIDs(
            from: sightings
        )
