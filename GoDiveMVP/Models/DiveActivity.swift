...
final class DiveActivity {
    ...
    /// Strava-style publish checkpoint: **`true`** on new activities until the owner chooses **Share**,
    /// dismisses the banner, or visits Activity Settings. Pre-existing records default **`false`** — no banner.
