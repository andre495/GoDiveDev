...
enum TripPlannerPresentation: Sendable {
    ...
    nonisolated static let tripNameSectionTitle = "Trip name"
    nonisolated static let tripNameFieldPlaceholder = "e.g. Bonaire 2026"
    nonisolated static let countriesEmptySelectionMessage = "None selected yet"
    nonisolated static let addCountriesButtonTitle = "Add countries"
    nonisolated static let addCountriesAccessibilityLabel = "Add countries to trip"
    nonisolated static let countriesPickerSearchPrompt = "Search countries"
    nonisolated static let countriesPickerFooter =
        "Tap countries to add or remove them. Changes save when you tap Done."
    nonisolated static let countriesPickerEmptySearchMessage = "No countries match your search."
    nonisolated static let buddiesSectionTitle = "Buddies"
    nonisolated static let addBuddiesButtonTitle = "Add buddies"
    nonisolated static let addBuddiesAccessibilityLabel = "Add buddies to trip"
    nonisolated static let buddiesEmptySelectionMessage = "None selected yet"
    nonisolated static let newTripFormFooterHint =
        "Name the trip, pick countries and dates, and optionally invite buddies."
    nonisolated static let editTripSheetTitle = "Edit trip"
    nonisolated static let addTripBuddiesAccessibilityIdentifier = "TripAddSheet.AddBuddies"
    nonisolated static let editTripBuddiesAccessibilityIdentifier = "TripEditSheet.AddBuddies"
    nonisolated static let addTripCountriesAccessibilityIdentifier = "TripAddSheet.AddCountries"
    nonisolated static let editTripCountriesAccessibilityIdentifier = "TripEditSheet.AddCountries"
    nonisolated static let countryPickerCancelAccessibilityIdentifier = "TripCountryPicker.Cancel"
    nonisolated static let countryPickerDoneAccessibilityIdentifier = "TripCountryPicker.Done"
