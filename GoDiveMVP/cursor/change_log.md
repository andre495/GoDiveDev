...
- **Trips list date range** — **`TripPlannerListRow`** renders the date range in **`AppTheme.Colors.accent`**; countries stay secondary caption text. **`TripPlannerListRowDisplayData`** splits **`dateRangeLine`** / **`countriesLine`**.
